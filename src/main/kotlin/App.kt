...
val developperMode = module {
    ...
    single<ITicketRepository> {  PostGreTicketRepositoryAdapter( "jdbc:postgresql://localhost:5432/mydatabase", "postgres",
        "example" ) }
}
...
val productionMode = module {
    ...
    single<ITicketRepository> {  PostGreTicketRepositoryAdapter( "jdbc:postgresql://instance001.iter.org:5432/prodBase", "SECRET",
        "SECRET" ) }
}
